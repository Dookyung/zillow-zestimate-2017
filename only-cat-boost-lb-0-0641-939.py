# -*- coding: utf-8 -*-
"""
Created on Mon Oct 16 01:35:41 2017
...
properties2016 = add_new_flat_features(properties2016)
properties2017 = add_new_flat_features(properties2017)
...
submission.to_csv('../output/Only_CatBoost.csv', float_format='%.6f',index=False)